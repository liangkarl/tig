...
|%(author)		|The currently selected commit author name.
|%(author-email)	|The currently selected commit author email.
|%(author-date)	|The currently selected author date in
			 `YYYY-MM-DD HH:MM:SS +ZZZZ` format.
|%(committer)		|The currently selected commit committer name.
|%(committer-email)	|The currently selected commit committer email.
|%(commit-date)		|The currently selected commit date in
			 `YYYY-MM-DD HH:MM:SS +ZZZZ` format.
...
|status-update-all       |Stage/unstage all file changes
